...
<tr>
<td colspan="3" align="center"><input type="text" size="12" name="myLine" value="0"></td>
...
<script>
  export default{
    ...
    methods : {
      ...
      clear : function myC(){	// クリアボタン[C]を押した
        myTotal = 0;	// 合計クリア
        myCalc = "+";	// 演算子クリア
        myInput = "";	// 現在入力している値をクリア
